...
GOOGLE_SECRET = os.environ.get('GOOGLE_SECRET') or 'Google secret key'
...
GOOGLE_CUSTOM_SEARCH_CLIENT_ID = os.environ.get('GOOGLE_CUSTOM_SEARCH_CLIENT_ID') or ''
GOOGLE_CUSTOM_SEARCH_ENGINE_ID = os.environ.get('GOOGLE_CUSTOM_SEARCH_ENGINE_ID') or ''
GOOGLE_CUSTOM_SEARCH_PK_FILE = os.environ.get('GOOGLE_CUSTOM_SEARCH_PK_FILE') or ''
